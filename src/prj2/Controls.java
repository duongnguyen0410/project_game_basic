...
import static prj2.GameManager.SGY;

import static prj2.GameManager.map;
import static prj2.GameManager.playgame;
import static prj2.GameManager.shop;
import static prj2.Shop.SGX;
		...
		if (!playgame)
		{
			...
			if (key==KeyEvent.VK_ENTER && SGY==370)
			{
                ...
                ta.setText("\n Sử dụng các phím mũi tên để di chuyển"
                		+ "\n Bấm J để tấn công, K để dung skill, L để hồi máu"
